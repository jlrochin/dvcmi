    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Verifica la conexión con el servicio de autenticación de Supabase
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Intenta iniciar sesión con credenciales específicas
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Verifica que estás usando el nombre de usuario y contraseña correctos. Recuerda que el sistema usa el campo "username" para iniciar sesión, no el email directamente.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              El sistema requiere que cada usuario tenga una entrada correspondiente en la tabla "users" con campos como "username" y "role".
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Verifica que las credenciales de Supabase (URL y clave anónima) sean correctas en el archivo lib/supabase.ts.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Si no puedes iniciar sesión, puedes crear un usuario administrador directamente desde la interfaz de Supabase:
